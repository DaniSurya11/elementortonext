export function CoverSpacerSection() {
  return (
    <div
      className="elementor-element elementor-element-6715487c gc-element gc-element-6715487c e-con-full elementor-hidden-mobile elementor-hidden-tablet e-flex e-con e-child elementor-sticky elementor-sticky__spacer gc-sticky__spacer"
      data-id="6715487c"
